...
describe('ProductCard', () => {
  ...
  it('renders low stock warning when stock < 5', () => {
    render(
      <ProductCard product={{ ...mockProduct, stock: 3 }} onDelete={() => {}} deleting={false} />
    );
  ...
  it('renders out of stock when stock is 0', () => {
    render(
      <ProductCard product={{ ...mockProduct, stock: 0 }} onDelete={() => {}} deleting={false} />
    );
  ...
  it('calls onDelete with product id when Delete button clicked', async () => {
    ...
    render(<ProductCard product={mockProduct} onDelete={onDelete} deleting={false} />);
